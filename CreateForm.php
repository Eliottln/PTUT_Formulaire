    ...
    <main>
        ...
        <aside id="palette">
            ...
            <ul>
                ...
                <li>
                    <div id="NewPage" class="button" title="New Page">New Page</div>
                </li>
                <hr>
                <li>
                    <form id="addSection">
                        <button type="button" id="new-checkbox" title="checkbox">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-color" title="color">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-date" title="date">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-email" title="email">@
                            Email
                        </button>
                        <button type="button" id="new-number" title="number">1
                            Nombre
                        </button>
                        <button type="button" id="new-radio" title="radio">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-range" title="range">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-select" title="select">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-tel" title="tel">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-text" title="text">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-textarea" title="textarea">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.5 3H3V6.5H4V4H6.5V3Z" fill="currentColor" />
                                <path d="M8.5 4V3H11V4H8.5Z" fill="currentColor" />
                                <path d="M13 4H15.5V3H13V4Z" fill="currentColor" />
                        ...
                        <button type="button" id="new-url" title="url">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" id="new-file" title="file">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
